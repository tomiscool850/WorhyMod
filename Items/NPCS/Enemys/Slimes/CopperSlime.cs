...
namespace WorhyMod.Items.NPCS.Enemys.Slimes
{
	public class CopperSlime : ModNPC
	{
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			...
			npcLoot.Add(ItemDropRule.Common(ItemID.CopperBar, 3));
			npcLoot.Add(ItemDropRule.Common(ItemID.CopperBar));
		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Great for getting copper, dont know why you would need that though to be hosnest.")
			});
		}
