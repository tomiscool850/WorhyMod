...
namespace WorhyMod.Items.NPCS.Enemys.Slimes
{
	public class IronSlime : ModNPC
	{
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			...
			npcLoot.Add(ItemDropRule.Common(ItemID.IronBar, 3));
			npcLoot.Add(ItemDropRule.Common(ItemID.IronBar));
		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Great for getting Iron, dont know why you would need that though to be hosnest.")
			});
		}
