...
namespace WorhyMod.Items.NPCS.Enemys.Slimes
{
    public class SilverSlime : ModNPC
    {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ItemID.SilverBar, 3));
            npcLoot.Add(ItemDropRule.Common(ItemID.SilverBar));
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Great for getting Silver, dont know why you would need that though to be hosnest.")
            });
        }
