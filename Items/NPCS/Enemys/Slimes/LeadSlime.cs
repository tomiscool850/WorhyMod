...
namespace WorhyMod.Items.NPCS.Enemys.Slimes
{
	public class LeadSlime : ModNPC
	{
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot)
		{
			...
			npcLoot.Add(ItemDropRule.Common(ItemID.LeadBar, 3));
			npcLoot.Add(ItemDropRule.Common(ItemID.LeadBar));
		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Great for getting Lead, dont know why you would need that though to be hosnest.")
			});
		}
