...
namespace WorhyMod.Items.NPCS.Enemys.Slimes
{
    public class SapphireSlime : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("Sapphire Slime");
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ItemID.Sapphire, 3));
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Great for getting Sapphire, dont know why you would need that though to be hosnest.")
            });
        }
