...
namespace WorhyMod.Items.NPCS.Enemys.Slimes
{
    public class TungstenSlime : ModNPC
    {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ItemID.TungstenBar, 3));
            npcLoot.Add(ItemDropRule.Common(ItemID.TungstenBar));
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Great for getting Tungsten, dont know why you would need that though to be hosnest.")
            });
        }
