...
{
    public class SilverFishingRod : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Silver Fishing Rod");
            Tooltip.SetDefault("Wow fishing with Silver.\n" +
        ...
        public override void SetDefaults()
        {
            ...
            Item.fishingPole = 68;
            Item.shootSpeed = 12f;
            Item.shoot = ModContent.ProjectileType<Projectiles.Bobbers.SilverBobber>();
        }
