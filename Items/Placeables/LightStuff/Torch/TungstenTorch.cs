...
{
    public class TungstenTorch : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("the glow of Tungsten.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Items.Tiles.LightStuff.Torch.TungstenTorchTile>();
            Item.width = 10;
            Item.height = 12;
            Item.value = 50;
        }
