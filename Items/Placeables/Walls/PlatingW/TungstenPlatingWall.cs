...
{
    public class TungstenPlatingWall : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createWall = ModContent.WallType<Items.Tiles.Walls.PlatingW.TungstenPlatingWallTile>();

        }
        public override void AddRecipes()
        {
            CreateRecipe(4)
                .AddIngredient<TungstenPlating>()
