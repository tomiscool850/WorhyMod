...
{
    public class TinChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            ChestDrop = ModContent.ItemType<Items.Placeables.Furniture.Chest.TinChest>();
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeables.Furniture.Chest.TinChest>();
