...
{
    public class CopperChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            ChestDrop = ModContent.ItemType<Items.Placeables.Furniture.Chest.CopperChest>();

            ContainerName.SetDefault("Copper Chest");

            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Copper Chest");
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeables.Furniture.Chest.CopperChest>();
